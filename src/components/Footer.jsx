  ...
  return (
    <footer>
        <div className='py-4 overflow-hidden text-white bg-[#101013] mt-24'>
            <div className='flex flex-col w-full p-4 mx-auto space-y-6 text-sm text-white border-gray-700 fluid-container sm:space-y-0 sm:items-center md:flex-row md:justify-between'>
            ...
            <div className='w-full p-4 mx-auto space-y-2 text-xs border-gray-900 fluid-container text-white/50 sm:space-y-0 sm:flex sm:flex-row sm:justify-center sm:border-solid md:border-t'>
